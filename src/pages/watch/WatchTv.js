...
const WatchTv = () => {
    ...
    useEffect(() => {
        const getEspDetails = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/tv/${id}/season/${season}/episode/${esp}?api_key=${process.env.REACT_APP_API_KEY}`);
    ...
    useEffect(() => {
        const getEpisodes = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_ENDPOINT}/tv/${id}/season/${season}?api_key=${process.env.REACT_APP_API_KEY}`);
